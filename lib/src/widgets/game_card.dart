...
class GameCard extends StatelessWidget {
 ...
 Widget setRaritySizeAndShape(GameCardSize cardSize){
    if(cardSize == const GameCardSize.xxl()){
      return  const Icon(Icons.star, color: Colors.white, size: 12);
    }
    else if(cardSize == const GameCardSize.xl()){
      return  const Icon(Icons.star, color: Colors.white, size: 11);
    }
    else if(cardSize == const GameCardSize.lg()){
      return  const Icon(Icons.star, color: Colors.white, size: 9.5);
    }
    else if(cardSize == const GameCardSize.md()){
      return  const Icon(Icons.star, color: Colors.white, size: 7.5);
    }
    else if(cardSize == const GameCardSize.sm()){
      return  const Icon(Icons.star, color: Colors.white, size: 6.5);
    }
    else if(cardSize == const GameCardSize.xs()){
      return  const Icon(Icons.star, color: Colors.white, size: 4);
    }
    else if(cardSize == const GameCardSize.xxs()){
      return  const Icon(Icons.star, color: Colors.white, size: 3);
    }
    else{
          ...
          child: Transform(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  //alignment: Alignment.center,
                  alignment: const Alignment(-1.24, .515),
                  child: SizedBox(
                ...
                Align(
                  //alignment: Alignment.center,
                  alignment: const Alignment(1.1, .515),
                  child: SizedBox(
                    width: size.badgeSize.width,
                    height: size.badgeSize.height,
                    child: Stack(
                ...
                Align(
                  alignment: const Alignment(0, .97),
                  child: SizedBox(
